...
const Table = ({ variants, isLoading, error, onStatusChange, onSearch, searchTerm, onUpdate, productId }) => {
...
Table.propTypes = {
  ...
  productId: PropTypes.number.isRequired // Thêm productId vào PropTypes
};
