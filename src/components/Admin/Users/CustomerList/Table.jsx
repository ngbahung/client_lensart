...
const Table = ({ customers, isLoading, error, onStatusChange, onSearch, searchTerm, onUpdate }) => {
  ...
  const handleCreateSuccess = async () => {
    await onUpdate(); // Gọi fetchCustomers để cập nhật danh sách
    setShowCreateForm(false); // Đóng form sau khi cập nhật thành công
  };

  const handleEditSuccess = async () => {
    await onUpdate(); // Gọi fetchCustomers để cập nhật danh sách
    setEditingCustomer(null); // Đóng form sau khi cập nhật thành công
  };
