      ...
      <div className="max-w-lg w-full bg-white shadow-xl rounded-lg overflow-hidden">
        ...
        <div className="px-8 py-6">
          ...
          <div className="mt-8 space-y-4">
            <Link
              to="/"
              className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#6fd4d2] hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
              Về trang chủ
            </Link>
          </div>
