...
import { getProductById, getProductByCategoryId, transformProduct } from '../../api/productsAPI';
    ...
    useEffect(() => {
        const fetchProductData = async () => {
            try {
                ...
                setProduct({
                    ...productData,
                    branchPrices: productData.branchPrices || [] // Ensure branchPrices exists
                });
                
                // Fetch similar products based on category
                if (productData.category_id) {
                    const similarData = await getProductByCategoryId(productData.category_id);
