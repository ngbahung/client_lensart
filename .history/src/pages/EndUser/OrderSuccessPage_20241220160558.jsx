      ...
      <div className="max-w-lg w-full bg-white shadow-xl rounded-lg overflow-hidden">
        ...
        <div className="px-8 py-6">
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div className="flex items-center">
                  <FaReceipt className="h-6 w-6 text-indigo-600" />
                  <div className="ml-4">
                    <p className="text-sm font-medium text-gray-900">Mã đơn hàng</p>
                    <p className="text-lg font-bold text-indigo-600">#{paymentInfo.orderId}</p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  <FaShippingFast className="h-6 w-6 text-indigo-600" />
          ...
          <div className="mt-8 space-y-4">
            <Link
              to={`/orders/${paymentInfo?.orderId}`}
              className="w-full flex justify-center py-3 px-4 border border-indigo-600 rounded-md shadow-sm text-sm font-medium text-indigo-600 bg-white hover:bg-indigo-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
