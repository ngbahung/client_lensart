...
const GongKinhPage = () => {
    ...
    useEffect(() => {
        ...
        const filterTypes = ['style', 'material', 'gender'];
        ...
        filterTypes.forEach(type => {
            ...
            if (value) {
                newFilters[type] = [decodeURIComponent(value)];
            }
        });
            ...
            <div className="flex flex-col lg:flex-row gap-4 lg:gap-6">
                <div className="w-full lg:w-1/4">
                    <SideBar 
                        ...
                        filterOptions={{
                            style: ["Phi công", "Vuông", "Oval", "Không viền", "Mắt mèo"],
                            material: ["Kim loại", "Nhựa", "Titanium"],
