...
import { getBestSellingProducts, getNewestProductsgetProductByCategoryId, getProducts, transformProduct } from '../../api/productsApi';
    ...
    useEffect(() => {
        const fetchProducts = async () => {
          try {
            ...
            const transformedProducts = bestSellerData.map(product => transformProduct(product));
            setBestSellerProducts(transformedProducts);
            
            const newestData = await getProducts();
            const transformedNewest = newestData.map(product => transformProduct(product));
            setNewestProducts(transformedNewest);
