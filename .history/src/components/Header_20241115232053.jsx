...
const Header = () => {
    ...
    const navItems = [
        { 
            name: 'Gọng kính', 
            path: '/gong-kinh',
            subItems: ['Gọng kim loại', 'Gọng không viền', 'Gọng mắt mèo', 'Gọng Oval']
        },
        { 
            name: 'Kính mát', 
            path: '/kinh-mat',
            subItems: ['Kính mát nam', 'Kính mát nữ', 'Kính đi biển']
        },
        { 
            name: 'Tròng kính', 
            path: '/trong-kinh',
                        ...
                        <nav className="hidden md:flex space-x-4 lg:space-x-8">
                            {navItems.map((item) => (
                                <div key={item.path} className="relative group">
                                    <Link
                                        to={item.path}
                                        className="flex items-center text-gray-600 hover:text-white transition-colors text-sm lg:text-base"
                                    >
                                        {item.name}
