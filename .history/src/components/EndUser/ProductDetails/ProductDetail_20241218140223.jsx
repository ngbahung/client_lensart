...
const ProductDetails = ({ product, selectedBranch, cityNames }) => {  {/* Add cityNames to props */}
    ...
    useEffect(() => {
        if (!selectedColor || !selectedBranch) {
            ...
            setQuantity(1); // Reset quantity when color or branch changes
            return;
        }
        ...
        // Ensure quantity doesn't exceed new available quantity
    ...
    const handleAddToCart = async () => {
        ...
        try {
            const result = await createCartDetail(
                product.id,
    ...
    const renderQuantityControls = () => (
        <div className="flex items-center space-x-4 mt-6">
            ...
            <button 
                ...
                disabled={!selectedColor || quantity >= availableQuantity}
            >
                +
            </button>
