...
const ProductDetails = ({ product, selectedBranch, cityNames, productWishlistId }) => {  {/* Add cityNames to props */}
    ...
    // Add this check for lens products
    const isLensProduct = product.category?.name === "Tròng kính";
    ...
    const handleAddToCart = async () => {
        ...
        try {
            await addToCart(
                ...
                isLensProduct ? ' ' : selectedColor, // Pass empty string for lens products
                quantity
            );
        } catch (error) {
