...
const ProductDetails = ({ product, selectedBranch, onBranchChange, branchPrices }) => {
    ...
    return (
        <>
            ...
            <div className="flex items-center gap-4 mt-4">
                ...
                <span className="text-sm text-gray-500">Còn lại: {product.remainingQuantity}</span>
            </div>
            ...
            <div className="mt-6 space-y-2">
                <h3 className="text-lg font-semibold">Chọn chi nhánh:</h3>
                <select
                    onChange={(e) => onBranchChange(e.target.value)}
                    value={selectedBranch?.branchId}
                    className="w-full p-2 border rounded-md bg-gray-50 hover:bg-gray-100 transition-colors"
                >
