                                ...
                                <nav className="hidden md:flex space-x-4 lg:space-x-8">
                                    {navItems.map((item) => (
                                        <div key={item.path} className="relative group">
                                            ...
                                            {/* Navigation Dropdown */}
                                            <div className="absolute left-full top-0 invisible group-hover:visible opacity-0 
                                                group-hover:opacity-100 transition-all duration-300 ease-in-out -ml-2 w-48 
                                                bg-[#6fd4d2] rounded-md shadow-lg z-50 transform translate-x-2
                                                hover:visible hover:opacity-100">
                                                <div className="py-2 relative">
                                                    {/* Add arrow indicator */}
                                                    <div className="absolute left-0 top-4 -translate-x-2 w-0 h-0 
                                                        border-t-[6px] border-t-transparent
                                                        border-r-[6px] border-r-[#6fd4d2]
