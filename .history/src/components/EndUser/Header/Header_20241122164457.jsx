...
const Header = () => {
    ...
    const navItems = [
        { 
            name: 'Gọng kính', 
            path: '/san-pham/gong-kinh',
            subItems: [
                { 
                    name: 'Gọng Kim Loại', 
                    filterType: 'chat-lieu',
                    filterValue: 'kim-loai'
                },
                { 
                    name: 'Gọng Không Viền', 
                    filterType: 'kieu-dang',
                    filterValue: 'khong-vien'
                },
                { 
                    name: 'Gọng Mắt Mèo', 
                    filterType: 'style',
    ...
    const additionalLinks = [
        { name: 'Về LensArt', path: '/gioi-thieu' },
        { name: 'Blog', path: '/tin-tuc' },
                                                    ...
                                                    {Array.isArray(item.subItems) && item.subItems.map((subItem) => (
                                                        <Link
                                                            ...
                                                            to={subItem.filterType && subItem.filterValue ? 
                                                                `${item.path}/loc/${subItem.filterType}/${encodeURIComponent(subItem.filterValue)}` :
                                                                item.path}
