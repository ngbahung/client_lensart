...
const Header = () => {
    ...
    const navItems = [
        { 
            ...
            path: '/gong-kinh',
            subItems: [
                { name: 'Gọng Kim Loại', filter: 'material=Kim loại' },
                { name: 'Gọng Không Viền', filter: 'style=Không viền' },
                { name: 'Gọng Mắt Mèo', filter: 'style=Mắt mèo' },
                { name: 'Gọng Oval', filter: 'style=Oval' },
                { name: 'Gọng Kính Nhựa', filter: 'material=Nhựa' }
            ]
        },
        { 
            name: 'Kính mát', 
