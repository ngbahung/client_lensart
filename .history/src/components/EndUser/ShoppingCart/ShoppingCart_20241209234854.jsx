...
const ShoppingCart = ({ cartItems, onUpdateCart, onContinueShopping, onCheckout, onSelectItem, onSelectAll, onCartQuantityChange }) => {
  ...
  }, [totalQuantity, onCartQuantityChange]);
