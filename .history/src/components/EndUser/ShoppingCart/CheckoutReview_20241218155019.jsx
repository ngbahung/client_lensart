...
const CheckoutReview = ({ cartItems, onUpdateCart, onBackToCart, onCheckout }) => {
  ...
  return (
    <div className="w-full lg:max-w-md mx-auto p-4 md:p-6 space-y-3 md:space-y-5 bg-[#eff9f9] border-2 border-[#55d5d2] rounded-lg">
      ...
      <div className="flex justify-end mt-3">
        <button 
          className="bg-[#ec905c] text-white w-full px-4 md:px-5 py-2 md:py-2.5 rounded-lg text-base disabled:opacity-50"
