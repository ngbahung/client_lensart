    ...
    <div className="p-8 space-y-8">
      ...
      <div className="space-y-4">
        <div className="flex justify-between py-2">
          ...
          <span className="text-lg">{subtotal} đ</span>
        </div>
        <div className="flex justify-between py-2">
      ...
      <div className="flex justify-end space-x-4 py-4">
        <button className="bg-gray-200 text-black px-6 py-2 rounded-lg">Quay lại giỏ hàng</button>
        <button className="bg-orange-500 text-white px-6 py-2 rounded-lg">Đặt hàng</button>
      </div>
    </div>
  );
};
