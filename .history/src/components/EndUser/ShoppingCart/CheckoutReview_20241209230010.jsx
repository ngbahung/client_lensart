...
const CheckoutReview = ({ cartItems, onUpdateCart, onBackToCart }) => {
  ...
  return (
    <div className="max-w-md mx-auto p-6 space-y-5 bg-[#eff9f9] rounded-lg">
      {/* Coupon Field */}
      <div className="flex space-x-3">
        ...
        <button
          ...
          className="bg-[#ec905c] text-white px-4 py-3 rounded-lg flex items-center gap-1 text-sm"
        >
          <FaTicketAlt size={14} />
          Áp dụng
        </button>
      ...
      <div className="flex justify-end mt-3">
        <button 
          className="bg-[#ec905c] text-white px-5 py-2.5 rounded-lg text-sm"
