...
const BlogCard = ({ blog }) => {
  return (
    ...
    <div className="max-w-sm rounded-xl overflow-hidden shadow-lg bg-white transition-all duration-300 hover:shadow-xl">
      ...
      {blog?.image && (
        <div className="w-full h-32 sm:h-36 md:h-48 overflow-hidden group">
          <img 
            src={blog.image} 
            alt={blog.title} 
      ...
      <div className="p-2 sm:p-3 md:p-4">
        ...
        <div className="flex justify-between items-center">
          ...
          <button className="flex items-center gap-1 md:gap-2 text-[#55d5d2] text-xs sm:text-sm md:text-base transition-colors">
            <span>ĐỌC TIẾP</span>
