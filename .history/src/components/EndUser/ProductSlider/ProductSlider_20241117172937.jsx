...
const CustomArrow = ({ direction, onClick }) => {
    const arrowClass = `absolute ${direction === 'left' ? '-left-6' : '-right-6'} top-1/2 -translate-y-1/2 
        bg-white rounded-full p-2.5 shadow-md cursor-pointer z-10 hover:bg-gray-100 transition-colors`;
