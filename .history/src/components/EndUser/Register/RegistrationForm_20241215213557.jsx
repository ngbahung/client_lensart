...
const RegistrationForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const cityName = locations.cities.find(c => c.value === formData.city)?.label || '';
    const districtName = locations.districts.find(d => d.value === formData.district)?.label || '';
    const wardName = locations.wards.find(w => w.value === formData.ward)?.label || '';
    const fullAddress = `${formData.address}, ${wardName}, ${districtName}, ${cityName}`;
