...
const BuyButton = memo(({ onClick, id, price }) => (  // Add price prop
  <button
    onClick={(e) => {
      e.stopPropagation();
      onClick(id);
...
const ProductCard = ({
  ...
  <div className="w-full bg-white rounded-xl shadow-md p-3 relative hover:shadow-xl transition-shadow flex flex-col h-[350px]">
    ...
    <div className="mt-auto pt-4">
      <BuyButton onClick={onBuyClick} id={id} price={currentPrice} />
    </div>
  </div>
);
...
// Update PropTypes to include price for BuyButton
BuyButton.propTypes = {
