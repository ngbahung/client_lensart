...
const Header = () => {
    ...
    return (
        <>
            {/* Mobile Menu Button */}
            <button 
                className="md:hidden fixed top-4 left-4 z-50 p-2 rounded-lg bg-[#6fd4d2] text-white"
            ...
            <Link 
                to="/gio-hang"
                className="md:hidden fixed top-4 right-4 z-50 p-2 rounded-lg bg-[#6fd4d2] text-white"
            >
            ...
            <Link 
                to="/gio-hang"
                className="md:hidden fixed bottom-4 right-4 z-50 p-3 rounded-full bg-[#6fd4d2] text-white shadow-lg hover:bg-[#5fc2c0] transition-colors"
            >
                <div className="relative">
                    <BsCart3 className="h-6 w-6" />
                    {cartCount > 0 && (
                    ...
                    <div className="p-6 space-y-4">
                        ...
                        {navItems.map((item) => (
                            <div key={item.path} className="space-y-2">
                                <Link
                                    to={item.path}
                                    className="block text-gray-700 hover:text-[#6fd4d2] transition-colors"
                                ...
                                <div className="pl-4 space-y-2">
                                    {item.subItems.map((subItem, index) => (
                                        <Link
                                            ...
                                            className="block text-sm text-gray-600 hover:text-[#6fd4d2] transition-colors"
                                            onClick={() => setIsSidebarOpen(false)}
                                        >
                                            {subItem}
                                        </Link>
            ...
            <header className="w-full bg-white shadow-sm">
                ...
                {/* Second Row Navigation with Mobile Menu */}
                <div className="bg-[#6fd4d2] w-full">
                    <div className="container mx-auto px-4">
