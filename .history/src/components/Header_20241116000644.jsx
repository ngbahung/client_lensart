        ...
        <nav className="hidden md:flex space-x-4 lg:space-x-8">
            {navItems.map((item) => (
                <div key={item.path} className="relative group">
                    <Link
                        to={item.path}
                        className="flex items-center text-white hover:text-gray-200 transition-colors text-sm lg:text-base pb-2"
                    >
                        {item.name}
                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex items-center space-x-2 md:space-x-4">
                        ...
                        <button className="flex items-center p-2 md:px-4 md:py-2 rounded-full bg-[#F5A97F] text-white hover:bg-[#ec905c] transition-colors">
                            ...
                            <span className="font-semibold text-[15px] hidden md:inline">Ch��nh sách</span>
                        </button>
                    </div>
                </div>
            </div>
