            ...
            <div>
                ...
                <div>
                    ...
                    <div className="flex items-center space-x-8">
                        <Link to="/ve-lensart" className="text-gray-700 hover:text-gray-900">
                        Về LensArt
                        </Link>
                        ...
                        <Link to="/lien-he" className="text-gray-700 hover:text-gray-900">
                        Liên hệ
                        <ChevronDown className="h-4 w-4 ml-1 inline" />
                        </Link>
                        <Link to="/gio-hang" className="flex items-center text-gray-700 hover:text-gray-900">
                        <span>Giỏ hàng</span>
