...
export const getProductDetailsByProductIdAndBranchId = async (productId, brandId) => {
  try {
    const response = await api.get(`/active/product-details/getByProductAndBranchId/${productId}/${brandId}`);
    return response.data.data;
  } catch (error) {
